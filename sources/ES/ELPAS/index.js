...
var Categories = ['internacional', 'opinión', 'España'];
    ...
    (async () => {
        ...
        try {
            ...
            for (let i = 0; i < Categories.length; i++) {
                ...
                if (Category === "opinión") url = "https://elpais.com/tag/c/ac1a39ea27fc68d52e94d1751fc14765"
                if (Category === "España") url = "https://elpais.com/espana/"
                ...
                var PageData = await page.evaluate((Category) => {
                    ...
                    for (let j = 0; j < 4; j++) {
                        try{
                            if (articles[j].querySelector(titles)!= null && articles[j].querySelector(links) != null && articles[j].querySelector(images) != null) {
                                data.push({
                                    time: Date.now(),
                                    ...
                                    source: "EL PAIS - " + Category.charAt(0).toUpperCase() + Category.slice(1),
