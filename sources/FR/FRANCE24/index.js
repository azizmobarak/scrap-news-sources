...
var Categories=['france','Afrique','Etats-Unis'];
...
for(let i=0;i<Categories.length;i++){
    ...
    if(Category==="Afrique") url="https://www.france24.com/fr/afrique/";
    if(Category==="Etats-Unis") url="https://www.france24.com/fr/am%C3%A9riques/";
    ...
    var titles = document.querySelectorAll('.m-item-list-article p');
        ...
        var data =[];
         for(let j=0;j<5;j++){
              ...
              if(typeof(titles[j])!="undefined" && typeof(links[j])!="undefined" && images[j].src.indexOf('data:image')==-1){
                   data.push({
                       time : Date.now(),
